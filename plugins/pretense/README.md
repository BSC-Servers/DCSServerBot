...
DEFAULT:
  ...
  DCS.dcs_serverrelease:
    lua_file_path: '{instance.home}\Missions\Saves\player_stats_ucid.lua'      # this is the default
    #json_file_path: '{instance.home}\Missions\Saves\player_stats.json'        # legacy JSON fallback
...
## File Upload
You can upload a modified pretense*.json, pretense*.lua, or player_stats_ucid.lua by dragging and dropping them into your admin folder.
